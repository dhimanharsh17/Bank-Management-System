...
//Banking Record System , C++ Project by Harsh Dhiman 
#include <iostream>
...
int main() {
    ...
    do {
        ...
        case '8':
            cout << "\n\n\tThanks for using Bank Record System.\n\n\tFor more cool stuff, visit https://github.com/dhimanharsh17";
            cout << "\n\n\n\n\n\tDo you want to visit my Website [Y/N]: ";
            cin >> my_url;
            my_url = toupper(my_url);
            if (my_url == 'Y') {
                system("start https://github.com/dhimanharsh17");
            }
            break;
        default:
            cout << "\a";
...
void Credit() {
    system_clear();
    cout << "\n\nBanking Record System Project by Harsh Dhiman." << "\nWritten in C++.";
}
